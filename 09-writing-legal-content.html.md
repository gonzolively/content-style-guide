...
The way we write, review, and publish legal content is different than how we do many other kinds of writing at Observe. The most important difference is that all legal content either starts with or passes through the Legal team.

But that doesn't mean legal content has to be difficult to read. We try to present our legal information in the most pleasant way possible. Our goals for Observe's legal content are:
...
We keep these in one place on our [legal page](http://observe.com/legal/):

* [Terms of use](http://observe.com/legal/terms/)
* [Acceptable use policy](http://observe.com/legal/acceptable_use/)
* [Privacy policy](http://observe.com/legal/privacy/)
* [API use policy](http://observe.com/legal/api_use/)
* [Copyright policy](http://observe.com/legal/copyright/)

These policies apply to all of Observe’s users. The Legal and Communication teams work together to make them as transparent and easy to read as possible. When someone signs up to use Observe, they must agree to all of those terms.
...
- [Terms of Use and anti-spam requirements](https://observe.com/help/terms-of-use-and-anti-spam-requirements/)
- [About the Canada anti-spam law](https://observe.com/help/about-the-canada-anti-spam-law-casl/)
- [Stay compliant with CASL](https://observe.com/help/stay-compliant-with-casl/)
...
- Observe is owned and operated by The Rocket Science Group, LLC d/b/a Observe, a Georgia limited liability corporation (“Observe,” “we,” or “us”). As a user of the Service or a representative of an entity that’s a user of the Service, you're a “Member” according to this agreement (or “you”).
...
While we want to inform our users about legal issues related to their use of Observe, we can’t offer them legal advice. Sometimes it’s a fine line. The legal department will check for this in their content review.
