...
Specify time zones when writing about an event or something else people would need to schedule. Since Observe is in Atlanta, we default to ET.
...
- “Using Observe has helped our business grow,” says Jamie Smith.
...
#### Writing about Observe

Our company's legal entity name is "The Rocket Science Group, LLC." Our trade name is "Observe." Use "The Rocket Science Group, LLC" only when writing legal documents or contracts. Otherwise, use "Observe."

Always capitalize the first “M” and lowercase the “c” in Observe.

Refer to Observe as “we,” not “it.”

Capitalize branded terms, like Observe Presents. We also capitalize pricing plan names (Premium, Standard, Essentials, and Free) to distinguish them from generic use of those adjectives.

Don’t capitalize descriptive product or feature names, like email or landing pages. 

- templates
- Observe’s mobile app
- Essentials plan
...
- Observe's Ops team is constantly scaling our servers to make sure our users have a great experience with our products. One way we do this is with shards, or partitions, that help us better horizontally scale our database infrastructure.
...
Use italics when citing an example of an in-app Observe element, or referencing button and navigation labels in step-by-step instructions:
